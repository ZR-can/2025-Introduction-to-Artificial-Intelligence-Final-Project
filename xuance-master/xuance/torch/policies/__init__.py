...
from .deterministic_marl import TDDPG_policy

from .oqmix_policy import MY_MixingQnetwork
...
REGISTRY = {
    ...
    "Independent_DDPG_Policy_mytest": TDDPG_policy,
...
Policy_Inputs = {
    ...
    "MATD3_Policy": ["action_space", "n_agents", "representation", "actor_hidden_size", "critic_hidden_size",
                     "normalize", "initialize", "activation", "device"],
    "MY_QMIX": ["action_space", "n_agents", "representation", "mixer", "hidden_sizes",
                         "normalize", "initialize", "activation", "device"],
}
