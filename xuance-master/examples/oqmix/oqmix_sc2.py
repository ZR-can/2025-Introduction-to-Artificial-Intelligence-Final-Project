...
def parse_args():
    ...
    parser.add_argument("--method", type=str, default="oqmix")
    parser.add_argument("--env", type=str, default="sc2")
    parser.add_argument("--env-id", type=str, default="5m_vs_6m")
    parser.add_argument("--seed", type=int, default=1)
    parser.add_argument("--test", type=int, default=0)
    parser.add_argument("--device", type=str, default="cuda:0")
    parser.add_argument("--benchmark", type=int, default=1)
    parser.add_argument("--config", type=str, default=f"./oqmix_sc2_configs/{parser.parse_args().env_id}.yaml")
...
class Runner(object):
    def __init__(self, args):
        ...
        # build QMIX agents.
        from xuance.torch.agents import OQMIX_Agents
        self.agents = OQMIX_Agents(args, self.envs, args.device)
