...
def parse_args():
    ...
    parser.add_argument("--method", type=str, default="wqmix")
    ...
    parser.add_argument("--config", type=str, default=f"./wqmix_sc2_configs/{parser.parse_args().env_id}.yaml")
...
class Runner(object):
    def __init__(self, args):
        ...
        self.agents = WQMIX_Agents(args, self.envs, args.device)
