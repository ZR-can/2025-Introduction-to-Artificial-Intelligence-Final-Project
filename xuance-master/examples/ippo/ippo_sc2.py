...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="2s3z")
    parser.add_argument("--seed", type=int, default=1)
    parser.add_argument("--test", type=int, default=0)#test
    
    parser.add_argument("--device", type=str, default="cuda:0")
    parser.add_argument("--config", type=str, default=f"./ippo_sc2_configs/{parser.parse_args().env_id}.yaml")
